				...
				<div className="relative w-full">
					<div className="relative">
						...
						<input
							...
							autoComplete="off"
							ref={inputRef}
							className="bg-white dark:bg-black border border-neutral-300 dark:border-neutral-700 text-sm rounded-l-lg disabled:cursor-not-allowed block w-full p-2.5 duration-200" // pl-10
