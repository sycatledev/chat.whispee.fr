export default function formatTimestampToTimeDifference(timestamp) {
    ...
    if (yearsDifference > 0) {
        ...
        result = `${secondsDifference} second${secondsDifference > 1 ? "s" : ""
            } ago`;
    } else {
        result = `just now`;
    }
    ...
    if (secondsDifference >= 5) {
        ...
        result += `, ${formattedHour}:${minutes < 10 ? "0" + minutes : minutes
            }${ampm}`;
    }
